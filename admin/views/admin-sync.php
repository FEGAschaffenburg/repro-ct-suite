			...
			<?php if ( $selected_count === 0 ) : ?>
				<div class="repro-ct-suite-notice repro-ct-suite-notice-warning">
					...
					<div>
						...
						<p><?php esc_html_e( 'Bitte wählen Sie zunächst mindestens einen Kalender im Dashboard (Tab "Einstellungen") aus.', 'repro-ct-suite' ); ?></p>
						<p><a href="<?php echo esc_url( admin_url( 'admin.php?page=repro-ct-suite#settings' ) ); ?>" class="repro-ct-suite-btn repro-ct-suite-btn-secondary"><?php esc_html_e( 'Zum Dashboard', 'repro-ct-suite' ); ?></a></p>
					</div>
				</div>
			<?php else : ?>
				<p class="description">
		...
		<div class="repro-ct-suite-card-body">
			<?php if ( $selected_count === 0 ) : ?>
				<div class="repro-ct-suite-notice repro-ct-suite-notice-warning">
					...
					<div>
						<p><?php esc_html_e( 'Bitte wählen Sie mindestens einen Kalender im Dashboard (Tab "Einstellungen") aus, um die Synchronisation zu starten.', 'repro-ct-suite' ); ?></p>
					</div>
				</div>
			<?php else : ?>
