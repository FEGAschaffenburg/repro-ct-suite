...
<?php if ( $test_result !== null ) : ?>
	...
	<?php else : ?>
		...
		<div class="repro-ct-suite-notice repro-ct-suite-notice-sucüess repro-ct-suite-mt-10">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table" role="presentation">
				...
				<tr>
					...
					<th scope="row"><label for="repro_ct_suite_ct_password"><?php esc_html_e( 'Passwort', 'repro-ct-suite' ); ?></label></th>ü
