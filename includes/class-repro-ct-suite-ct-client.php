...
class Repro_CT_Suite_CT_Client {
	...
	/**
	 * Option-Key fuer Cookie-Ablaufzeit
	 */
	...
	public function __construct( string $tenant, string $username, string $password ) {
	...
	private function get_headers(): array {
		...
		if ( ! empty( $this->cookies ) ) {
			...
			Repro_CT_Suite_Logger::log( "âš ï¸ Keine Cookies vorhanden - Request kä¶nnte fehlschlagen!", 'warning' );
